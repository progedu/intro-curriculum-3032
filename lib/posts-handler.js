// 1. /posts にアクセスしたときにトークンを作る。
// 2. トークンは投稿、投稿の削除に使われる。
// 3. 投稿、投稿の削除の処理はどちらも終わったら同じで、handleRedirectPosts関数が呼び出されて /posts に戻る
// 4. /posts に戻ったのでまたトークンを作る
// 5. 以後これの繰り返し
